...
/**
 * Class representing window for removing friends
 * @author USER
 */
public class RemoveFriendView extends JFrame implements IView {
    ...
    public RemoveFriendView() {
        ...
        inputs.add(label);
        friendField = UIFactory.createTextField(ButtonType.SUBMIT_REMOVE_FRIEND);
        ...
        //Add buttons
        submitBtn = UIFactory.createButton(ButtonType.SUBMIT_REMOVE_FRIEND);
        ...
        this.reset();
        this.setTitle(WindowType.REMOVE_FRIEND.getName());
